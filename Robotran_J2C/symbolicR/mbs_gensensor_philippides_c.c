...
MbsData *s, int isens)
{
#include "mbs_gensensor_philippides_c.h"
...
RLcp8_18 = ROcp8_77*dpt[3][7];
RLcp8_38 = ROcp8_97*dpt[3][7];
...
POcp11_32 = q[2]+dpt[3][1];
POcp11_23 = dpt[2][2]+dpt[2][3];
RLcp11_14 = Dz93*S3;
RLcp11_34 = Dz93*C3;
POcp11_14 = RLcp11_14+q[1];
POcp11_24 = POcp11_23+dpt[2][5];
...
POcp12_32 = q[2]+dpt[3][1];
POcp12_23 = dpt[2][2]+dpt[2][3];
RLcp12_14 = Dz93*S3;
RLcp12_34 = Dz93*C3;
POcp12_14 = RLcp12_14+q[1];
POcp12_24 = POcp12_23+dpt[2][5];
...
POcp13_32 = q[2]+dpt[3][1];
POcp13_23 = dpt[2][2]+dpt[2][3];
RLcp13_14 = Dz93*S3;
RLcp13_34 = Dz93*C3;
POcp13_14 = RLcp13_14+q[1];
POcp13_24 = POcp13_23+dpt[2][5];
...
RLcp13_18 = ROcp13_712*dpt[3][14];
RLcp13_38 = ROcp13_912*dpt[3][14];
