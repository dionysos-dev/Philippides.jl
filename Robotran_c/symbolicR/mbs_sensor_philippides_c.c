...
MbsData *s, int isens)
{
#include "mbs_sensor_philippides_c.h"
...
POcp1_32 = q[2]+dpt[3][1];
POcp1_23 = dpt[2][2]+dpt[2][3];
RLcp1_14 = Dz43*S3;
RLcp1_34 = Dz43*C3;
POcp1_14 = RLcp1_14+q[1];
POcp1_24 = POcp1_23+dpt[2][4];
...
RLcp1_18 = ROcp1_77*dpt[3][7];
RLcp1_38 = ROcp1_97*dpt[3][7];
...
RLcp1_19 = ROcp1_18*dpt[1][8]+ROcp1_78*dpt[3][8];
RLcp1_39 = ROcp1_38*dpt[1][8]+ROcp1_98*dpt[3][8];
POcp1_19 = POcp1_18+RLcp1_19;
POcp1_29 = POcp1_24+dpt[2][8];
...
POcp2_32 = q[2]+dpt[3][1];
POcp2_23 = dpt[2][2]+dpt[2][3];
RLcp2_14 = Dz43*S3;
RLcp2_34 = Dz43*C3;
POcp2_14 = RLcp2_14+q[1];
POcp2_24 = POcp2_23+dpt[2][4];
...
RLcp2_18 = ROcp2_77*dpt[3][7];
RLcp2_38 = ROcp2_97*dpt[3][7];
...
RLcp2_19 = ROcp2_18*dpt[1][9]+ROcp2_78*dpt[3][9];
RLcp2_39 = ROcp2_38*dpt[1][9]+ROcp2_98*dpt[3][9];
POcp2_19 = POcp2_18+RLcp2_19;
POcp2_29 = POcp2_24+dpt[2][9];
...
POcp3_32 = q[2]+dpt[3][1];
POcp3_23 = dpt[2][2]+dpt[2][3];
RLcp3_14 = Dz43*S3;
RLcp3_34 = Dz43*C3;
POcp3_14 = RLcp3_14+q[1];
POcp3_24 = POcp3_23+dpt[2][4];
...
RLcp3_18 = ROcp3_77*dpt[3][7];
RLcp3_38 = ROcp3_97*dpt[3][7];
...
RLcp3_19 = ROcp3_78*dpt[3][10];
RLcp3_39 = ROcp3_98*dpt[3][10];
...
POcp4_32 = q[2]+dpt[3][1];
POcp4_23 = dpt[2][2]+dpt[2][3];
RLcp4_14 = Dz43*S3;
RLcp4_34 = Dz43*C3;
POcp4_14 = RLcp4_14+q[1];
POcp4_24 = POcp4_23+dpt[2][4];
...
RLcp4_18 = ROcp4_77*dpt[3][7];
RLcp4_38 = ROcp4_97*dpt[3][7];
...
RLcp4_19 = ROcp4_18*dpt[1][11]+ROcp4_78*dpt[3][11];
RLcp4_39 = ROcp4_38*dpt[1][11]+ROcp4_98*dpt[3][11];
POcp4_19 = POcp4_18+RLcp4_19;
POcp4_29 = POcp4_24+dpt[2][11];
...
POcp5_32 = q[2]+dpt[3][1];
POcp5_23 = dpt[2][2]+dpt[2][3];
RLcp5_14 = Dz43*S3;
RLcp5_34 = Dz43*C3;
POcp5_14 = RLcp5_14+q[1];
POcp5_24 = POcp5_23+dpt[2][4];
...
RLcp5_18 = ROcp5_77*dpt[3][7];
RLcp5_38 = ROcp5_97*dpt[3][7];
...
RLcp5_19 = ROcp5_18*dpt[1][12]+ROcp5_78*dpt[3][12];
RLcp5_39 = ROcp5_38*dpt[1][12]+ROcp5_98*dpt[3][12];
POcp5_19 = POcp5_18+RLcp5_19;
POcp5_29 = POcp5_24+dpt[2][12];
...
POcp6_32 = q[2]+dpt[3][1];
POcp6_23 = dpt[2][2]+dpt[2][3];
RLcp6_14 = Dz93*S3;
RLcp6_34 = Dz93*C3;
POcp6_14 = RLcp6_14+q[1];
POcp6_24 = POcp6_23+dpt[2][5];
...
RLcp6_18 = ROcp6_712*dpt[3][14];
RLcp6_38 = ROcp6_912*dpt[3][14];
...
RLcp6_19 = ROcp6_113*dpt[1][15]+ROcp6_713*dpt[3][15];
RLcp6_39 = ROcp6_313*dpt[1][15]+ROcp6_913*dpt[3][15];
POcp6_19 = POcp6_18+RLcp6_19;
POcp6_29 = POcp6_24+dpt[2][15];
...
POcp7_32 = q[2]+dpt[3][1];
POcp7_23 = dpt[2][2]+dpt[2][3];
RLcp7_14 = Dz93*S3;
RLcp7_34 = Dz93*C3;
POcp7_14 = RLcp7_14+q[1];
POcp7_24 = POcp7_23+dpt[2][5];
...
RLcp7_18 = ROcp7_712*dpt[3][14];
RLcp7_38 = ROcp7_912*dpt[3][14];
...
RLcp7_19 = ROcp7_113*dpt[1][16]+ROcp7_713*dpt[3][16];
RLcp7_39 = ROcp7_313*dpt[1][16]+ROcp7_913*dpt[3][16];
POcp7_19 = POcp7_18+RLcp7_19;
POcp7_29 = POcp7_24+dpt[2][16];
...
POcp8_32 = q[2]+dpt[3][1];
POcp8_23 = dpt[2][2]+dpt[2][3];
RLcp8_14 = Dz93*S3;
RLcp8_34 = Dz93*C3;
POcp8_14 = RLcp8_14+q[1];
POcp8_24 = POcp8_23+dpt[2][5];
...
RLcp8_18 = ROcp8_712*dpt[3][14];
RLcp8_38 = ROcp8_912*dpt[3][14];
...
RLcp8_19 = ROcp8_713*dpt[3][17];
RLcp8_39 = ROcp8_913*dpt[3][17];
...
POcp9_32 = q[2]+dpt[3][1];
POcp9_23 = dpt[2][2]+dpt[2][3];
RLcp9_14 = Dz93*S3;
RLcp9_34 = Dz93*C3;
POcp9_14 = RLcp9_14+q[1];
POcp9_24 = POcp9_23+dpt[2][5];
...
RLcp9_18 = ROcp9_712*dpt[3][14];
RLcp9_38 = ROcp9_912*dpt[3][14];
...
RLcp9_19 = ROcp9_113*dpt[1][18]+ROcp9_713*dpt[3][18];
RLcp9_39 = ROcp9_313*dpt[1][18]+ROcp9_913*dpt[3][18];
POcp9_19 = POcp9_18+RLcp9_19;
POcp9_29 = POcp9_24+dpt[2][18];
...
POcp10_32 = q[2]+dpt[3][1];
POcp10_23 = dpt[2][2]+dpt[2][3];
RLcp10_14 = Dz93*S3;
RLcp10_34 = Dz93*C3;
POcp10_14 = RLcp10_14+q[1];
POcp10_24 = POcp10_23+dpt[2][5];
...
RLcp10_18 = ROcp10_712*dpt[3][14];
RLcp10_38 = ROcp10_912*dpt[3][14];
...
RLcp10_19 = ROcp10_113*dpt[1][19]+ROcp10_713*dpt[3][19];
RLcp10_39 = ROcp10_313*dpt[1][19]+ROcp10_913*dpt[3][19];
POcp10_19 = POcp10_18+RLcp10_19;
POcp10_29 = POcp10_24+dpt[2][19];
